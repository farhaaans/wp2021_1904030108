...
<html lang="en">
  ...
  <body class="bg-secondary">
	...
	<div  style="padding-left:100px; padding-right:100px; padding-top:30px; padding-bottom:100px;">
		...
		<!--Konten -->
		<h3><i class="fas fa-book"></i></i>Data Buku Perpustakaan Cerdas</h3><hr>
		
		<ul class="list-group">
			<li class="list-group-item">Nama : <?= $buku['Nama']; ?></li>
			<li class="list-group-item">Tahun : <?= $buku['Tahun']; ?></li>
			<li class="list-group-item">Klasifikasi : <?= $buku['Klasifikasi']; ?></li>
			<li class="list-group-item">Jumlah : <?= $buku['Jumlah']; ?></li>
			<li class="list-group-item">
				<a href="hapusbuku.php?id=<?=  $buku['No']; ?>" onclick ="return confirm('apakah anda ingin menghapus data ini?');" class="btn btn-danger" role="button">Hapus</a>
				<a href="editbuku.php?id=<?=  $buku['No']; ?>" class="btn btn-warning" role="button">Edit</a>
