...
<html lang="en">
  ...
  <body class="bg-secondary">
	...
	<div style="padding-left:100px; padding-right:100px; padding-top:30px; padding-bottom:100px;">
		...
		<!--Konten -->
		<h3><i class="fas fa-user-circle"></i>Edit Anggota Perpustakaan</h3><hr>
		
		<form method="POST" action="" >
		
			<input type="hidden" class="form-control" value="<?= $anggota['No'] ?>" name="no">
		
			  <div class="form-group">
				<label for="nama">Nama : </label>
				<input type="text" class="form-control" id="nama" value="<?= $anggota['Nama'] ?>"  placeholder="Input Nama" name="nama" autofocus required autocomplete="off">
			  </div>
			  <div class="form-group">
				<label for="jenis kelamin">Jenis Kelamin : </label>
				<input type="text" class="form-control" id="jenis kelamin" value="<?= $anggota['Jenis Kelamin'] ?>" placeholder="jenis kelamin" name="jenis kelamin" required autocomplete="off">
			  </div>
			  <div class="form-group">
				<label for="alamat">Alamat : </label>
				<input type="text" class="form-control" id="alamat" value="<?= $anggota['Alamat'] ?>" placeholder="Input Alamat" name="alamat" required autocomplete="off">
			  </div>
			  <br>
