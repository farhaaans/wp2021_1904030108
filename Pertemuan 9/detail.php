  ...
  <body>
	...
	<div class="row">
		...
		<ul class="list-group">
			...
			<li class="list-group-item"><a href="edit.php?id=<?=  $camaba['Id']; ?>" class="btn btn-warning" role="button">Edit</a></li>
			<li class="list-group-item"><a href="hapus.php?id=<?=  $camaba['Id']; ?>" class="btn btn-danger" role="button">Hapus</a></li>
			<li class="list-group-item"><a href="index.php" class="btn btn-primary" role="button">Kembali</a></li>
